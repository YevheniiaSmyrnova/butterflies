...
from exhibition.views import ExhibitionListView, ExhibitionPastListView, ExhibitionDetailView, ExhibitionCreateView, ExhibitionUpdateView, ExhibitionDeleteView
